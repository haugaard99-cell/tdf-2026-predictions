...
const riders = [
    ...
    // 7. Netcompany INEOS
    "ARENSMAN Thymen (INE)", "BERNAL Egan (INE)", "FOSS Tobias (INE)", "GANNA Filippo (INE)",
    "GODON Dorian (INE)", "KWIATKOWSKI Michał (INE)", "TARLING Joshua (INE)", "VAUQUELIN Kévin (INE)",
    ...
    // 10. Movistar Team
    "UIJTDEBROEKS Cian (MOV)", "GARCIA PIERNA Raul (MOV)", "CASTRILLO Pablo (MOV)", "RUBIO Einer (MOV)",
    "ROMO Javier (MOV)", "OLIVEIRA Nelson (MOV)", "CEPEDA Jefferson Alveiro (MOV)", "HESSMANN Michel (MOV)",
    ...
    "PARET-PEINTRE Valentin (SQS)", "MERLIER Tim (SQS)", "EENKHOORN Pascal (SQS)", "STUYVEN Jasper (SQS)",
    "VAN BAARLE Dylan (SQS)", "VAN LERBERGHE Bert (SQS)", "VAN WILDER Ilan (SQS)", "VERVAEKE Louis (SQS)",
    ...
    "PIDCOCK Tom (PIN)", "WRIGHT Fred (PIN)", "HERMANS Quinten (PIN)", "MEURISSE Xandro (PIN)"
];
